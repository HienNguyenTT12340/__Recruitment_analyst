...
Tổng chỉ tiêu định biên: Số lượng nhân sự được phép tuyển theo ngân sách.

Nhân sự hiện có: Số lượng thực tế đang làm việc.

Tỷ lệ lấp đầy: Đánh giá mức độ đáp ứng nguồn lực (Hiện tại đạt 94.68%).

**Quản trị tuyển dụng:**

Vị trí đang tuyển: Tổng số job đang mở.

Phễu tuyển dụng (Recruitment Funnel): Theo dõi ứng viên qua các vòng (Hồ sơ -> Vòng 1 -> Vòng 2 -> Thỏa thuận -> Tiếp nhận công việc).

Tiến độ tuyển dụng (%): So sánh số lượng đã tuyển so với nhu cầu thực tế của từng bộ phận.

**3. Các tính năng nổi bật (Key Features)**

Phân tích Chênh lệch (Variance Analysis): Hệ thống tự động tính toán số nhân sự thừa/thiếu so với chỉ tiêu định biên để cảnh báo kịp thời cho bộ phận tuyển dụng.
...
**4.1. Khủng hoảng thiếu hụt trên toàn hệ thống**
...
Kiểm soát chặt chẽ vị trí đã đủ chỉ tiêu: Dừng ngay việc tuyển dụng tại các vị trí đã đạt hoặc vượt 100% tiến độ (đặc biệt là tại Dept B, A, C) để dồn nguồn lực cho các vị trí đang thiếu hụt.  
